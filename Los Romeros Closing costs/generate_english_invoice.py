...
output_path = os.path.join(
    ...
    "Calpe Notary Invoice - Deed of Ratification or Acceptance (A4 01026).pdf"
)
...
elements.append(Paragraph("Deed of Ratification or Acceptance — No Monetary Value", subtitle_style))
elements.append(Paragraph("Invoice No: <b>A4 / 01026</b>   |   Date: <b>20 March 2026</b>", subtitle_style))
...
trans_data = [
    ["Protocol Number", "N8261069B / 1088"],
    ["Legal Transaction", "Deed of Ratification or Acceptance (NO MONETARY VALUE)"],
...
fee_rows = [
    ["Deed of Ratification or Acceptance", "1", "2", "21%", "€30.05"],
    ...
    [Paragraph("<b>TOTAL FEES</b>", body_style), "", "", "", Paragraph("<b>€191.73</b>", body_style)],
]
...
disb_data = [
    ...
    [Paragraph("<b>TOTAL DISBURSEMENTS</b>", body_style), "", "", Paragraph("<b>€1.80</b>", body_style)],
]
...
summary_data = [
    ["Taxable Base (subject to VAT):", "€191.73"],
    ["Non-taxable Base:", "€1.80"],
    ["VAT (21% on €191.73):", "€40.26"],
    [Paragraph("<b>TOTAL INVOICE</b>", body_style), Paragraph("<b>€233.79</b>", body_style)],
]
...
pay_data = [
    ...
    ["Payment Reference:", "A4 / 01026  (please include when making payment)"],
]
...
elements.append(Paragraph(
    ...
    ParagraphStyle("Footer", parent=styles["Normal"], fontSize=7, textColor=colors.HexColor("#888888"), alignment=TA_CENTER)
))
